...
function Main_GPTs() {
  ...
  const translation: TranslationsType = {
    subtitle: {
      ...
      FR: "Renforcez vos compétences de développeur avec des GPT personnalisés pour le web, le mobile, l'IA et la blockchain.",
    },
    description: {
